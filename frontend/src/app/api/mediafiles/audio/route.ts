...
export async function GET(request: NextRequest) {
  console.log('🔵 GET /api/mediafiles/audio/ called');
  ...
  try {
    ...
    const djangoUrl = `${apiUrl}/api/mediafiles/audio/?category=${encodeURIComponent(category)}&page=${page}&page_size=${pageSize}`;
