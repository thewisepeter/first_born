  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        ...
        const publishedPosts = postsArray.filter((post: BlogPost) => post.status === 'Published');
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Failed to load blog posts</h3>
          ...
          {blogPosts.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">
                No published blog posts available at this time.
              </p>
              <p className="text-gray-400 mt-2">Please check back later for new articles.</p>
            </div>
          ) : (
            <>
                ...
                <>
                  ...
                  <div className="text-center mt-4">
                    <p className="text-gray-500 text-sm">
                      ...
                      {Math.min((currentPage + 1) * postsPerPage, blogPosts.length)} of{' '}
